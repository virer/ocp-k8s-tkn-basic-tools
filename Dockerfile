...
RUN tar  --no-same-owner -xzf "tkn_${TKN_VERSION}_Linux_x86_64.tar.gz" -C /usr/local/bin/
RUN tar  --no-same-owner -xzf "openshift-client-linux.tar.gz" -C /usr/local/bin/
